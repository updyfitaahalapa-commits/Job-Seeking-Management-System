...
<head>
    ...
    <title>Admin Dashboard - Job Seeking Management System</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <style>
        ...
        .hover-bg-light:hover { background-color: rgba(248, 250, 252, 0.8) !important; }
...
<body>
    <div class="sidebar">
        <div class="sidebar-header">
            ...
            <span class="small text-muted fw-semibold">Admin Panel</span>
        </div>
        <div class="py-4">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="jobs.php"><i class="fas fa-briefcase me-2"></i> Jobs</a>
                </li>
                <li class="nav-item">
        ...
        <div class="top-navbar d-flex align-items-center justify-content-between shadow-sm">
            ...
            <div class="d-flex align-items-center">
                <div class="me-3 text-end d-none d-md-block">
                    <p class="small fw-bold mb-0">Administrator</p>
                    <p class="small text-muted mb-0">System Control</p>
                </div>
