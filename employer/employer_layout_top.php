...
<head>
    ...
    <title>Employer Dashboard - Job Seeking Management System</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    <div class="sidebar">
        <div class="sidebar-header">
            ...
            <span class="small text-muted fw-semibold">Employer Panel</span>
        </div>
        <div class="py-4">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="manage_jobs.php"><i class="fas fa-tasks me-2"></i> Manage Jobs</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="view_applications.php"><i class="fas fa-users-cog me-2"></i> Applications</a>
                </li>
            </ul>
        ...
        <div class="top-navbar d-flex align-items-center justify-content-between shadow-sm">
            ...
            <div class="d-flex align-items-center">
                <div class="me-3 text-end">
                    ...
                    <p class="small text-muted mb-0">Employer Account</p>
                </div>
